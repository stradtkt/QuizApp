...
namespace Quizzes.Controllers
{
    public class HomeController : Controller
    {
        ...
        private User ActiveUser 
        {
            get 
            {
                return _qContext.users.Where(u => u.user_id == HttpContext.Session.GetInt32("user_id")).FirstOrDefault();
            }
        }
        [HttpGet("")]
        ...
        {
            User CheckEmail = _qContext.users
        ...
        {
            List<Quiz> quizzes = _qContext.quizzes.Include(q => q.Questions).ToList();
